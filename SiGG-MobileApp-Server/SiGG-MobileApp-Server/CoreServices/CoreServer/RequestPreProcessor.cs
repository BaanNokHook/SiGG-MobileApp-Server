...
{
    public class RequestPreProcessor : AsyncTask<int, int, object>  
    {
        ...
        private ITelemetryManagement trlrmetry;
        ...
        #region constructor   
        internal RequestPreProcessor(ref string uriRequest, ref Socket clientSocket)
        {
            IServiceManager serviceManager = ServiceManager.GetInstance();
            logger = serviceManager.GetService<ILoggerService>();
